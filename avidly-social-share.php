...
function avidly_social_share_callback( $attributes ) {
	return '<div class="avidly-social-share-block">' . avidly_social_share( 'avidly-social-share-template.php' ) . '</div>';
}
...
function avidly_set_social_medias() {
	...
	$medias = array(
		...
		'email' => array(
			...
			'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32" xml:space="preserve"><path d="M28.5 5.26h-25c-.69 0-1.25.56-1.25 1.25v17.55c0 .69.56 1.25 1.25 1.25h25c.69 0 1.25-.56 1.25-1.25V6.51c0-.69-.56-1.25-1.25-1.25zm-3.66 2.5L16 14.6 7.16 7.76h17.68zM4.75 22.82V9.06l10.48 8.11c.23.17.5.26.76.26s.54-.09.76-.26l10.49-8.11v13.76H4.75z" /></svg>',
		),
	);
